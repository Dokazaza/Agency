    ...
    return (
        <div className="mt-10 overflow-hidden bg-white py-24 sm:py-32">
            ...
            <div className="mt-12 mb-24">
                <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl flex justify-center">
                    <Underline>Explore My Most Recent Project</Underline>
                </h2>
            </div>
                ...
                <div
                    ...
                    <div className="lg:pr-8 lg:pt-4">
                        <div className="lg:max-w-lg">
                            ...
                            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Don
                                Holding</p>
                            ...
                            <Link
                                href="https://www.donholding.com.mk/index_en.html"
